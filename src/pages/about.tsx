...
const EDITOR_IN_CHIEF = {
  ...
  bio: "المدير العام والمالك ورئيس تحرير جريدة مغرب 24. يشرف على الخط التحريري للجريدة ويدير فريقها، ملتزم بتقديم محتوى إعلامي يخدم الشأن المغربي ويحترم ثوابت المملكة ومقدساتها.",
